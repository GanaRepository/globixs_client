...
// File: app/login/business/page.tsx
import { Metadata, Viewport } from 'next';
import BusinessLoginContent from './BusinessLoginContent';
...
export const metadata: Metadata = {
  ...
  title: 'Business Login | Globixs - Access Your Portal',
  description:
    'Access the Globixs business portal to manage your recruitment needs, staffing services, and connect with tech talent. Login to your business account.',
  keywords: [
    'Globixs',
    'business login',
    'business portal',
  ...
  openGraph: {
    ...
    description:
      'Access the Globixs business portal to manage your recruitment needs, staffing services, and connect with tech talent. Login to your business account.',
    url: 'https://www.globixs.com/login/business',
    siteName: 'Globixs',
    type: 'website',
    locale: 'en_US',
    images: [
      {
        url: '/business-login-og.jpg', // Update with your actual image path
        width: 1200,
        height: 630,
        alt: 'Globixs - Business Login',
      },
    ],
  },
  alternates: {
    canonical: 'https://www.globixs.com/login/business',
    languages: {
      'en-US': 'https://www.globixs.com/login/business',
    },
  },
  robots: {
    index: true,
