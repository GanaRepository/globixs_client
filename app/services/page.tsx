...
//               </p>
//               <p>
//                 At Globixs, we combine deep technical abilities with
//                 hands-on industry experience to complement our client&apos;s
//                 efforts at every stage of their technology journey. We
//                 don&apos;t just build solutions. we help organizations engineer
//                 sustainable success - designing systems and processes that stand
//                 the test of time, scale with ambition, and evolve alongside the
//                 market.
//               </p>
//             </div>
//           </div>
...
//         <div className="text-sm sm:text-base md:text-lg text-gray-700 space-y-4 max-w-7xl mx-auto px-4 pt-8 sm:pt-12 md:pt-20 bg-[#EAF6F6]">
//           At Globixs, we don&apos;t just deliver services — we
//           deliver possibilities. With a deep commitment to innovation, quality,
//           and partnership, we help you unlock new opportunities, overcome
//           complex challenges, and build a resilient digital future. Wherever you
//           are on your technology journey, we&apos;re ready to move forward with
//           you.
//         </div>
//       </section>
...
export const metadata: Metadata = {
  ...
  title:
    'IT Services | Globixs Technology Solutions - Technology Staff Augmentation & Software Development',
  description:
    "Explore Globixs Technology Solutions' comprehensive technology services including Staff Augmentation, IT Consulting, DevOps, and Software Development solutions for your business needs.",
  keywords: [
  ...
  openGraph: {
    title:
      'IT Services | Globixs - Technology Staff Augmentation & Software Development',
    description:
      "Explore Globixs' comprehensive technology services including Staff Augmentation, IT Consulting, DevOps, and Software Development solutions for your business needs.",
    url: 'https://www.globixs.com/services',
    siteName: 'Globixs',
    type: 'website',
    locale: 'en_US',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Globixs - Technology Services',
      },
    ],
  },
  alternates: {
    canonical: 'https://www.globixs.com/services',
    languages: {
      'en-US': 'https://www.globixs.com/services',
    },
  },
  robots: {
    index: true,
