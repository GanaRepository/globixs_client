...
//               At Globixs, we&apos;re passionate about sharing
//               insights, ideas, and innovations that drive the future of
//               technology. Our Media and Blogs section brings you thought
//               leadership, industry trends, success stories, and expert
//               perspectives from across the tech landscape. Whether you&apos;re
//               looking for practical advice, strategic insights, or a fresh take
//               on emerging technologies, you&apos;ll find it here. Explore our
//               latest updates and see how we&apos;re helping businesses stay
...
//       <div className="py-8 bg-[#EAF6F6] backdrop-blur-sm">
...
//       <div id="blogs-section" className="py-16 bg-[#EAF6F6] backdrop-blur-sm">
//         <div className="container mx-auto px-4">
//           <div
//             ref={blogsRef}
...
//                           <span className="bg-contact-purple text-white px-3 py-1 rounded-full text-xs font-medium">
//                             Featured
//                           </span>
//                         </div>
//                       )}
...
//                     <CardContent className="p-6">
//                       <div className="flex items-center gap-4 mb-3">
//                         <span className="text-xs font-medium text-contact-purple px-3 py-1 bg-contact-purple/10 rounded-full">
...
export const metadata: Metadata = {
  ...
  title: 'Media & Insights | Globixs Technology Solutions - Technology Thought Leadership',
  description:
    "Explore Globixs Technology Solutions' media center for insightful blogs, industry trends, technology insights, and expert perspectives to guide your business in digital transformation.",
  keywords: [
  ...
  publisher: 'Globixs',
  openGraph: {
    title: 'Media & Insights | Globixs - Technology Thought Leadership',
    description:
      "Explore Globixs' media center for insightful blogs, industry trends, technology insights, and expert perspectives to guide your business in digital transformation.",
    url: 'https://www.globixs.com/media',
    siteName: 'Globixs',
    type: 'website',
    locale: 'en_US',
    images: [
      {
        url: '/media-og-image.jpg', // Update with your actual image path
        width: 1200,
        height: 630,
        alt: 'Globixs - Media & Insights',
      },
    ],
  },
  alternates: {
    canonical: 'https://www.globixs.com/media',
    languages: {
      'en-US': 'https://www.globixs.com/media',
    },
  },
  robots: {
    index: true,
