...
export default function IndustriesContent(): JSX.Element {
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-base md:text-lg text-gray-700 space-y-4">
              <p>
                At Globixs Technology Solutions, we don&apos;t believe in one-size-fits-all. Every
                industry has unique challenges, pressures, and opportunities —
                and we&apos;re here to meet them head-on. With deep domain
                understanding and a flexible delivery model, we help businesses
                across sectors accelerate transformation, modernize operations,
