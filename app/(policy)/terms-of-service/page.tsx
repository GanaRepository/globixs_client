    ...
    <div className="container mx-auto px-4 py-16 min-h-screen mt-8">
      ...
      <div className="prose prose-lg max-w-none text-gray-900 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <p>
            By accessing or using Globixs Technology Solutions services, you agree to be bound by
        ...
        <div className="space-y-4">
          ...
          <p>
            ...
            terminated by Globixs Technology Solutions at any time.
          </p>
        ...
        <div className="space-y-4">
          ...
          <p>
            ...
            by Globixs Technology Solutions and are protected by international copyright, trademark,
        ...
        <div className="space-y-4">
          ...
          <p>
            Globixs Technology Solutions shall not be liable for any indirect, incidental, special,
        ...
        <div className="space-y-4">
          ...
          <ul className="list-none space-y-2">
            <li>By email: Connect@Globixs.com</li>
            <li>
              By mail: 1729 208th ST SE, Suite 103, Bothell, WA 98021
            </li>
          </ul>
        </div>
      </div>
